 ...
 *
 */
public class SimpleInsertMethodGenerator extends AbstractDAOElementGenerator {

    public SimpleInsertMethodGenerator() {
        super();
    }
    ...
    public void addImplementationElements(TopLevelClass topLevelClass) {
        ...
        sb.append(daoTemplate.getInsertMethod(introspectedTable.getBaseRecordType().getFullyQualifiedName(), 
                ...
                .getSimpleInsertMethodName(introspectedTable), paramBaseRecord())); //$NON-NLS-1$
        ...
        if (ibatorContext.getPlugins().daoInsertGenerated(method, topLevelClass, introspectedTable)) {
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        if (ibatorContext.getPlugins().daoInsertGenerated(method, interfaze, introspectedTable)) {
    ...
    private Method getMethodShell(Set<FullyQualifiedJavaType> importedTypes) {
        ...
        method.addParameter(new Parameter(parameterType, paramBaseRecord())); //$NON-NLS-1$
